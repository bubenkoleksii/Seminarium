...
public class ChangeGroupNoticeCrucialCommandHandler(ISchoolProfileManager schoolProfileManager, IMapper mapper, ICommandContext commandContext)
    : IRequestHandler<ChangeGroupNoticeCrucialCommand, Either<GroupNoticeModelResponse, Error>>
{
    ...
    public async Task<Either<GroupNoticeModelResponse, Error>> Handle(ChangeGroupNoticeCrucialCommand request, CancellationToken cancellationToken)
    {
